...
/**
 * StringifyVisitor renders arithmetic expressions in prefix, infix or postfix notation.
...
public class StringifyVisitor extends Visitor {
    ...
    private final Deque<String> renderedExpressions = new ArrayDeque<>(); // stack to keep track of the rendered sub-expressions

    /**
     * Class constructor specifying the notation to be used for rendering the expression.
     *
    ...
    public void visit(Operation o) {
        ...
        Collections.reverse(args); // reverse the order of the arguments to match the original order in the expression
        ...
        String joined = String.join(", ", args); // join the arguments with a comma and a space for rendering in prefix and postfix notation
        ...
        renderedExpressions.push(rendered); // push the rendered expression back on the stack for further processing by the parent operation
    }

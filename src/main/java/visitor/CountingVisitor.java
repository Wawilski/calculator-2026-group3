...
/**
 * CountingVisitor computes depth, number of operations and number of numbers in an expression
...
public class CountingVisitor extends Visitor {
    ...
    private final Deque<Integer> depths = new ArrayDeque<>(); // stack to keep track of the depth of the current expression
